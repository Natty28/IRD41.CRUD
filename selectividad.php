<?php
	...
	echo "<div class='aqui' style='background-color: white'>"	;
	  ...
	  while($row = $result->fetch_assoc()) {
		...
		echo "<td>
		<a href='./form.php?idenv=".$row["id"]."&marca=".$row["marca"]."&modelo=".$row["modelo"]."&genero=".$row["genero"]."&talla=".$row["talla"]."&color=".$row["color"]."&cantidad=".$row["cantidad"]."&stock=".$row["stock"]."'><img src='images.jpg'></a>
		</td>";
		echo "<td>
		<a href='./eliminar.php?idenv=".$row["id"]."'><img src='images.png'></a>
		</td>";
		echo "</tr>";
	  }
	} else {
